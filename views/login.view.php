...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Employe Portal</h2>
  </div>
      ...
      <div>
        ...
        <div class="mt-2">
          ...
          <?php if (isset($errors['passworderror'])): ?>
              <p class="text-red-500 text-xs mt-2"> *<?= $errors['passworderror'] ?></p>
              <?php endif; ?>
              <?php if (isset($errors['loginerror'])): ?>
              <p class="text-red-500 text-xs mt-2"> *<?= $errors['loginerror'] ?></p>
              <?php endif; ?>
        </div>
      </div>
